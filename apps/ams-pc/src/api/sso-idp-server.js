 ...
 * 获取账号信息 (项目初始化数据调用)
 */
// export function accountByAccess() {
 ...
 * 是否有更多的应用 (项目初始化数据调用)
 */
// export function accountAccessHaveMore() {
 ...
 * 获取某个账号的角色 + 数据权限
 */
export function functionCodeAccessListByAccountApp(params) {
  return idpHttp.POST('/function/code/access/list/by/account/app', params)
}
...
export function orgGet(params) {
  return idpHttp.POST('/org/get', params || {})
}
 ...
 * 人员 - 同步
 */
export function syncFromErp() {
  return idpHttp.POST_SYNC('/account/u8/sync')
}
...
/** 忘记密码 - 修改密码 */
export function accountActiveList(params) {
  return idpHttp.GET('/account/active/list', params)
}
...
export function companyPage(params) {
  return idpHttp.POST('/company/page', params)
}

export function saveCompany(params) {
  return idpHttp.POST('/company/save', params)
}

export function getCompany(params) {
  return idpHttp.POST('/company/select', params)
}

export function listAllCompany(data) {
  return idpHttp.POST('/company/list/all', data)
}
