    ...
    <el-form class="app-main" ref="formRef" :model="formData" :rules="rules" label-width="140px">
      ...
      <div class="app-row">
        <el-form-item label="URL:" prop="url">
          <el-input v-model="formData.url" placeholder="请输入URL" clearable maxlength="255" class="input400" />
        </el-form-item>
      </div>
      ...
      <div class="app-row" v-if="formData.type === 'endpoint'">
        <el-form-item label="是否隐藏:" prop="hidden">
          <el-radio-group v-model="formData.hidden">
            <el-radio :label="true">是</el-radio>
            <el-radio :label="false">否</el-radio>
...
<script>
import { handleCascaderStuck, objectDeepCopy } from '@/utils/commonTools'
import { functionCodeAdd, functionCodeById, functionCodeList, functionCodeUpdate } from '@/api/sso-idp-server'
