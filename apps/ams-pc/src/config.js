...
const associationServices = [
  ...
  // 流程中台
  { url: '', prefix: '/process-service-server', target: process.env.VUE_APP_URL },
  // 基础中台
  { url: '', prefix: '/base-service-server', target: process.env.VUE_APP_URL },
  // 消息中台
  { url: '', prefix: '/message-service-server', target: process.env.VUE_APP_URL },
  // 管理平台
